...
public class QualityBound{
     ...
     */
    public static class InformationGainBound extends ShapeletQualityBound{
     ...
     * the set of distances from the shapelet to a dataset.
     */
    public static class MoodsMedianBound extends ShapeletQualityBound{
     ...
     * the set of distances from the shapelet to a dataset.
     */
    public static class FStatBound extends ShapeletQualityBound{
     ...
     * the set of distances from the shapelet to a dataset.
     */
    public static class KruskalWallisBound extends ShapeletQualityBound{
